...
assert.ok(ui.includes('/assets/webde-guide.mp4?v=20260922-1'));
...
assert.ok(ui.includes('document.getElementById("emailProviderConnectSecret")?.addEventListener("focus", prefetchWebdeGuideAudio);'));
