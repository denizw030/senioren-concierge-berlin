...
test("composer rollout busts both integration and product asset caches",()=>{
  assert.match(integration,/email-concierge-product\.js\?v=20260924-compose1/);
  assert.match(integration,/email-concierge-product\.css\?v=20260924-compose1/);
  assert.match(konto,/email-account-integration\.js\?v=15/);
});
