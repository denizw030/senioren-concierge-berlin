...
test("light account hamburger menu uses light account surface", () => {
  assert.match(ui, /html\[data-nw-portal-theme="light"\] body\.account-premium-ui\.nw-portal-light \.top \.links/);
