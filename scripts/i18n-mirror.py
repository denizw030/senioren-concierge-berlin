...
def mirror_page(lang: str, page: str, catalog: dict[str, str]) -> None:
    ...
    html = re.sub(r"/assets/language-switcher\.js\?v=\d+", "/assets/language-switcher.js?v=9", html)
...
def update_root_switcher_version() -> None:
    for page in PAGES:
        path = ROOT / page
        text = re.sub(r"/assets/language-switcher\.js\?v=\d+", "/assets/language-switcher.js?v=9", path.read_text(encoding="utf-8"))
