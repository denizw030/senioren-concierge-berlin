(() => {
  ...
  function ensureModal() {
    ...
    document.getElementById("emailProviderWebdeVideoToggle")?.addEventListener("click", toggleWebdeGuideVideo);
  ...
  function resetWebdeGuideVideo() {
    ...
    if (button) {
      button.textContent = "Video-Anleitung ansehen";
      button.setAttribute("aria-expanded", "false");
    }
  }

  function toggleWebdeGuideVideo() {
    ...
    if (opening) {
      video.hidden = false;
      button.textContent = "Video ausblenden";
