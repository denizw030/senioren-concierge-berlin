(() => {
  ...
  function removeFloatingConcierge() {
    const link = document.getElementById("nwFloatingConcierge");
    const landmark = link?.closest("[data-nw-floating-concierge-landmark]");
    (landmark || link)?.remove();
  }
  function ensureFloatingConcierge() {
    ...
    landmark.dataset.nwFloatingConciergeLandmark = "true";
    landmark.setAttribute("aria-label", "Concierge-Schnellzugriff");
